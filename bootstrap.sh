...
echo "installing RVM and ruby-2.0.0 - depending on your computer and internet connection, this can take up to 20 mins"
...
echo installing locomotivecms_wagon 1.5.8
gem install locomotivecms_wagon -v=1.5.8 >/dev/null 2>&1
